...
System-wide ADRs live in the root `docs/adr/`. Context-specific ADRs live in the owning context's `docs/adr/`. Each directory uses sequential numbering: `0001-slug.md`, `0002-slug.md`, etc.
