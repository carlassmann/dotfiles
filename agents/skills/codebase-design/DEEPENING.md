...
## Testing strategy: replace equivalent coverage

- Make the deepened module's interface the primary test surface.
- Delete old tests only after equivalent behavioural coverage exists through that interface.
- Preserve or add focused contract and integration tests for production adapters and internal seams whose behaviour an in-memory adapter cannot exercise.
